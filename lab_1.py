...
print(teor)
#ex_1 = np.linespace(min(edges),max(edges))
#plt.hist(ex, ex, alpha = 0.5, label='Теоретическая', width=0.15, color='green') # Teor
#plt.hist(ex, edges, alpha = 0.5, label='Экспериментальная', width=0.17)
